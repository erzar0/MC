                            ...
                            if "palette" in block_states:
                                    ...
                                    if "minecraft:numerical" in b_name:
                                        ...
                                        if props:
                                            ...
                                            for k, v in sorted(props.items()):
                                                v_str = v.py_str if hasattr(v, "py_str") else str(v.py_data if hasattr(v, "py_data") else v)
                                ...
                                if "data" in block_states:
                                    ...
                                    if hasattr(data_tag, "py_ndarray"):
                                        ...
                                        data_array = np.array(data_tag.py_data if hasattr(data_tag, "py_data") else data_tag.value, dtype=np.int64)
