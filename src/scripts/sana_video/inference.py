...
def generate_grid(
    ...
    *,
    ...
    Args:
        ...
        frames: Number of vertical layers (Y axis of the grid).
        seed: Random seed for generation.
        block_states: Optional path to ``block_states.txt``.
        block_state2rgb: Optional path to ``block_state2rgb.csv``.
    ...
    id2rgb, _ = load_id2rgb(block_states, block_state2rgb)
...
def main():
    ...
    categorical_grid = generate_grid(
        ...
        block_state2rgb=args.block_state2rgb,
    )
